...
use crate::innodb::file_list::FileListBaseNode;
...
impl LobHeader {
    pub fn try_from_bytes(buf: &[u8]) -> Result<Self> {
        ...
        let last_transaction_id = u64::from_be_bytes([0, 0, buf[6], buf[7], buf[8], buf[9], buf[10], buf[11]]);
        ...
        let transaction_id = u64::from_be_bytes([0, 0, buf[20], buf[21], buf[22], buf[23], buf[24], buf[25]]);
